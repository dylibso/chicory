...
- we [completed the work on the **Ahead-of-Time** translator](#ahead-of-time-translation):
  this translator is a drop-in replacement for the interpreter, and is 100% compatible 
  with the specs supported in interpreter mode (`aot` is currently marked as experimental).
...
```java
var module = Module.builder("path/to/your.wasm").build();
