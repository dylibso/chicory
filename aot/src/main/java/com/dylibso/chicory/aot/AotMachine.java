...
public final class AotMachine implements Machine {
    ...
    private void compileBody(
        ...
        for (AnnotatedInstruction ins : body.instructions()) {
            ...
            for (int i = 0; i < ins.labelTableSize(); i++) {
                labels.put(ins.labelTable(i), new Label());
            }
        }
        ...
        for (int idx = 0; idx < body.instructions().size(); idx++) {
            ...
            switch (ins.opcode()) {
                ...
                case BR_TABLE:
                    ...
                    Label[] table = new Label[ins.labelTableSize() - 1];
                    ...
                    int defaultTarget = ins.labelTable(ins.labelTableSize() - 1);
