...
public enum OpCode {
    ...
    STRUCT_NEW_DEFAULT(0xFB00, List.of(VARUINT)),
    ...
    REF_TEST(0xFB14, List.of(VARUINT)),
    REF_TEST_NULL(0xFB15, List.of(VARUINT)),
    CAST_TEST(0xFB16, List.of(VARUINT)),
    CAST_TEST_NULL(0xFB17, List.of(VARUINT)),
    BR_ON_CAST(0xFB18, List.of(BYTE, VARUINT, VARUINT, VARUINT)),
    BR_ON_CAST_FAIL(0xFB19, List.of(BYTE, VARUINT, VARUINT, VARUINT)),
    ...
    MEM_ATOMIC_NOTIFY(0xFE00, List.of(BYTE, VARUINT)),
    MEM_ATOMIC_WAIT32(0xFE01, List.of(BYTE, VARUINT)),
    MEM_ATOMIC_WAIT64(0xFE02, List.of(BYTE, VARUINT)),
    ATOMIC_FENCE(0xFE03, List.of(BYTE)),
    I32_ATOMIC_LOAD(0xFE10, List.of(BYTE, VARUINT)),
    I64_ATOMIC_LOAD(0xFE11, List.of(BYTE, VARUINT)),
    I32_ATOMIC_LOAD8_U(0xFE12, List.of(BYTE, VARUINT)),
    I32_ATOMIC_LOAD16_U(0xFE13, List.of(BYTE, VARUINT)),
    I64_ATOMIC_LOAD8_U(0xFE14, List.of(BYTE, VARUINT)),
    I64_ATOMIC_LOAD16_U(0xFE15, List.of(BYTE, VARUINT)),
    I64_ATOMIC_LOAD32_U(0xFE16, List.of(BYTE, VARUINT)),
    I32_ATOMIC_STORE(0xFE17, List.of(BYTE, VARUINT)),
    I64_ATOMIC_STORE(0xFE18, List.of(BYTE, VARUINT)),
    I32_ATOMIC_STORE8(0xFE19, List.of(BYTE, VARUINT)),
    I32_ATOMIC_STORE16(0xFE1A, List.of(BYTE, VARUINT)),
    I64_ATOMIC_STORE8(0xFE1B, List.of(BYTE, VARUINT)),
    I64_ATOMIC_STORE16(0xFE1C, List.of(BYTE, VARUINT)),
    I64_ATOMIC_STORE32(0xFE1D, List.of(BYTE, VARUINT)),
    I32_ATOMIC_RMW_ADD(0xFE1E, List.of(BYTE, VARUINT)),
    I64_ATOMIC_RMW_ADD(0xFE1F, List.of(BYTE, VARUINT)),
    I32_ATOMIC_RMW8_ADD_U(0xFE20, List.of(BYTE, VARUINT)),
    I32_ATOMIC_RMW16_ADD_U(0xFE21, List.of(BYTE, VARUINT)),
    I64_ATOMIC_RMW8_ADD_U(0xFE22, List.of(BYTE, VARUINT)),
    I64_ATOMIC_RMW16_ADD_U(0xFE23, List.of(BYTE, VARUINT)),
    I64_ATOMIC_RMW32_ADD_U(0xFE24, List.of(BYTE, VARUINT)),
    I32_ATOMIC_RMW_SUB(0xFE25, List.of(BYTE, VARUINT)),
    I64_ATOMIC_RMW_SUB(0xFE26, List.of(BYTE, VARUINT)),
    I32_ATOMIC_RMW8_SUB_U(0xFE27, List.of(BYTE, VARUINT)),
    I32_ATOMIC_RMW16_SUB_U(0xFE28, List.of(BYTE, VARUINT)),
    I64_ATOMIC_RMW8_SUB_U(0xFE29, List.of(BYTE, VARUINT)),
    I64_ATOMIC_RMW16_SUB_U(0xFE2A, List.of(BYTE, VARUINT)),
    I64_ATOMIC_RMW32_SUB_U(0xFE2B, List.of(BYTE, VARUINT)),
    I32_ATOMIC_RMW_AND(0xFE2C, List.of(BYTE, VARUINT)),
    I64_ATOMIC_RMW_AND(0xFE2D, List.of(BYTE, VARUINT)),
    I32_ATOMIC_RMW8_AND_U(0xFE2E, List.of(BYTE, VARUINT)),
    I32_ATOMIC_RMW16_AND_U(0xFE2F, List.of(BYTE, VARUINT)),
    I64_ATOMIC_RMW8_AND_U(0xFE30, List.of(BYTE, VARUINT)),
    I64_ATOMIC_RMW16_AND_U(0xFE31, List.of(BYTE, VARUINT)),
    I64_ATOMIC_RMW32_AND_U(0xFE32, List.of(BYTE, VARUINT)),
    I32_ATOMIC_RMW_OR(0xFE33, List.of(BYTE, VARUINT)),
    I64_ATOMIC_RMW_OR(0xFE34, List.of(BYTE, VARUINT)),
    I32_ATOMIC_RMW8_OR_U(0xFE35, List.of(BYTE, VARUINT)),
    I32_ATOMIC_RMW16_OR_U(0xFE36, List.of(BYTE, VARUINT)),
    I64_ATOMIC_RMW8_OR_U(0xFE37, List.of(BYTE, VARUINT)),
    I64_ATOMIC_RMW16_OR_U(0xFE38, List.of(BYTE, VARUINT)),
    I64_ATOMIC_RMW32_OR_U(0xFE39, List.of(BYTE, VARUINT)),
    I32_ATOMIC_RMW_XOR(0xFE3A, List.of(BYTE, VARUINT)),
    I64_ATOMIC_RMW_XOR(0xFE3B, List.of(BYTE, VARUINT)),
    I32_ATOMIC_RMW8_XOR_U(0xFE3C, List.of(BYTE, VARUINT)),
    I32_ATOMIC_RMW16_XOR_U(0xFE3D, List.of(BYTE, VARUINT)),
    I64_ATOMIC_RMW8_XOR_U(0xFE3E, List.of(BYTE, VARUINT)),
    I64_ATOMIC_RMW16_XOR_U(0xFE3F, List.of(BYTE, VARUINT)),
    I64_ATOMIC_RMW32_XOR_U(0xFE40, List.of(BYTE, VARUINT)),
    I32_ATOMIC_RMW_XCHG(0xFE41, List.of(BYTE, VARUINT)),
    I64_ATOMIC_RMW_XCHG(0xFE42, List.of(BYTE, VARUINT)),
    I32_ATOMIC_RMW8_XCHG_U(0xFE43, List.of(BYTE, VARUINT)),
    I32_ATOMIC_RMW16_XCHG_U(0xFE44, List.of(BYTE, VARUINT)),
    I64_ATOMIC_RMW8_XCHG_U(0xFE45, List.of(BYTE, VARUINT)),
    I64_ATOMIC_RMW16_XCHG_U(0xFE46, List.of(BYTE, VARUINT)),
    I64_ATOMIC_RMW32_XCHG_U(0xFE47, List.of(BYTE, VARUINT)),
    I32_ATOMIC_RMW_CMPXCHG(0xFE48, List.of(BYTE, VARUINT)),
    I64_ATOMIC_RMW_CMPXCHG(0xFE49, List.of(BYTE, VARUINT)),
    I32_ATOMIC_RMW8_CMPXCHG_U(0xFE4A, List.of(BYTE, VARUINT)),
    I32_ATOMIC_RMW16_CMPXCHG_U(0xFE4B, List.of(BYTE, VARUINT)),
    I64_ATOMIC_RMW8_CMPXCHG_U(0xFE4C, List.of(BYTE, VARUINT)),
    I64_ATOMIC_RMW16_CMPXCHG_U(0xFE4D, List.of(BYTE, VARUINT)),
    I64_ATOMIC_RMW32_CMPXCHG_U(0xFE4E, List.of(BYTE, VARUINT)),
    ;
