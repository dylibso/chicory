...
public final class OpcodeImpl {
    ...
    public static int REF_EQ(int a, int b, Instance instance) {
        if (a == b) {
            return 1;
        }
    ...
    public static int STRUCT_NEW(long[] fields, int typeIdx, Instance instance) {
        var struct = new WasmStruct(typeIdx, fields);
        return instance.registerGcRef(struct);
    }

    public static int STRUCT_NEW_DEFAULT(int typeIdx, Instance instance) {
    ...
    public static long STRUCT_GET(int ref, int typeIdx, int fieldIdx, Instance instance) {
        if (ref == Value.REF_NULL_VALUE) {
    ...
    public static long STRUCT_GET_S(int ref, int typeIdx, int fieldIdx, Instance instance) {
        if (ref == Value.REF_NULL_VALUE) {
            throw new TrapException("null structure reference");
        }
        var struct = (WasmStruct) instance.gcRef(ref);
    ...
    public static long STRUCT_GET_U(int ref, int typeIdx, int fieldIdx, Instance instance) {
        if (ref == Value.REF_NULL_VALUE) {
            throw new TrapException("null structure reference");
        }
        var struct = (WasmStruct) instance.gcRef(ref);
    ...
    public static void STRUCT_SET(int ref, long val, int typeIdx, int fieldIdx, Instance instance) {
        if (ref == Value.REF_NULL_VALUE) {
            throw new TrapException("null structure reference");
        }
        var struct = (WasmStruct) instance.gcRef(ref);
    ...
    public static int ARRAY_NEW(long initVal, int len, int typeIdx, Instance instance) {
    ...
    public static int ARRAY_NEW_DEFAULT(int len, int typeIdx, Instance instance) {
    ...
    public static int ARRAY_NEW_FIXED(long[] vals, int typeIdx, Instance instance) {
        var arr = new WasmArray(typeIdx, vals);
        return instance.registerGcRef(arr);
    }

    public static int ARRAY_NEW_DATA(
    ...
    public static int ARRAY_NEW_ELEM(
    ...
    public static long ARRAY_GET(int ref, int idx, int typeIdx, Instance instance) {
        if (ref == Value.REF_NULL_VALUE) {
    ...
    public static long ARRAY_GET_S(int ref, int idx, int typeIdx, Instance instance) {
        if (ref == Value.REF_NULL_VALUE) {
            throw new TrapException("null array reference");
        }
        var arr = (WasmArray) instance.gcRef(ref);
    ...
    public static long ARRAY_GET_U(int ref, int idx, int typeIdx, Instance instance) {
        if (ref == Value.REF_NULL_VALUE) {
            throw new TrapException("null array reference");
        }
        var arr = (WasmArray) instance.gcRef(ref);
    ...
    public static void ARRAY_SET(int ref, int idx, long val, int typeIdx, Instance instance) {
        if (ref == Value.REF_NULL_VALUE) {
            throw new TrapException("null array reference");
        }
        var arr = (WasmArray) instance.gcRef(ref);
    ...
    public static int ARRAY_LEN(int ref, Instance instance) {
        if (ref == Value.REF_NULL_VALUE) {
            throw new TrapException("null array reference");
        }
        var arr = (WasmArray) instance.gcRef(ref);
    ...
    public static int REF_TEST(int ref, int heapType, int srcHeapType, Instance instance) {
        return instance.heapTypeMatch(ref, false, heapType, srcHeapType) ? 1 : 0;
    }

    public static int REF_TEST_NULL(int ref, int heapType, int srcHeapType, Instance instance) {
        return instance.heapTypeMatch(ref, true, heapType, srcHeapType) ? 1 : 0;
    }

    public static int REF_CAST(int ref, int heapType, int srcHeapType, Instance instance) {
    ...
    public static int REF_CAST_NULL(int ref, int heapType, int srcHeapType, Instance instance) {
    ...
    public static int REF_I31(int val, Instance instance) {
        var i31 = new WasmI31Ref(val & 0x7FFFFFFF);
        return instance.registerGcRef(i31);
    }

    public static int I31_GET_S(int ref, Instance instance) {
        if (ref == Value.REF_NULL_VALUE) {
    ...
    public static int I31_GET_U(int ref, Instance instance) {
        if (ref == Value.REF_NULL_VALUE) {
            throw new TrapException("null i31 reference");
        }
        var i31 = (WasmI31Ref) instance.gcRef(ref);
    ...
    public static long elementValueToRef(long val, Instance instance) {
        if (Value.isI31(val)) {
    ...
    static long readFromData(byte[] data, int offset, int size) {
        long val = 0;
