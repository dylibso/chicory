...
public class ChicoryApiTest {
    ...
    public void shouldCreateStaticProxy() {
        ...
        HelloWorld hw = new StaticHelloWorldProxy();
     ...
     */
    static class StaticHelloWorldProxy extends ChicoryProxyFactory.WasmInvocationAdapter implements HelloWorld, ChicoryProxyFactory.ChicoryProxy {
        ...
        static {
            module = Module.build(ChicoryProxyFactory.resolveModule(Thread.currentThread().getContextClassLoader(), "wasm/count_vowels.rs.wasm"));
        ...
        public int countVowels(String input) {
            return (Integer) invokeInternal(instance, countVowels_function, int.class, new Class[]{String.class}, new Object[]{input});
        }
    }
